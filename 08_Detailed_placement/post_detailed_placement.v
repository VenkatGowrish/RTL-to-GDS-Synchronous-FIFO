module fifo_top (clk,
 ...
 INV_X1 \controller/_41_  (.A(wr_en),
    .ZN(\controller/_05_ ));
 NOR2_X1 \controller/_42_  (.A1(\controller/count [0]),
    .A2(\controller/count [1]),
    .ZN(\controller/_06_ ));
 NOR3_X1 \controller/_43_  (.A1(\controller/count [0]),
    .A2(\controller/count [1]),
    .A3(\controller/count [2]),
    .ZN(\controller/_07_ ));
 NOR4_X1 \controller/_44_  (.A1(\controller/count [0]),
    .A2(\controller/count [1]),
    .A3(\controller/count [2]),
    .A4(\controller/count [3]),
    .ZN(\controller/_08_ ));
 OR4_X1 \controller/_45_  (.A1(\controller/count [0]),
    .A2(\controller/count [1]),
    .A3(\controller/count [2]),
    .A4(\controller/count [3]),
    .ZN(\controller/_09_ ));
 NOR2_X1 \controller/_46_  (.A1(\controller/count [4]),
    .A2(\controller/_09_ ),
    .ZN(empty));
 OAI21_X1 \controller/_47_  (.A(rd_en),
    .B1(\controller/_09_ ),
    .B2(\controller/count [4]),
    .ZN(\controller/_10_ ));
 INV_X1 \controller/_48_  (.A(\controller/_10_ ),
    .ZN(rd_ptr_en));
 AND2_X1 \controller/_49_  (.A1(\controller/count [4]),
    .A2(\controller/_08_ ),
    .ZN(full));
 AOI21_X1 \controller/_50_  (.A(\controller/_05_ ),
    .B1(\controller/_08_ ),
    .B2(\controller/count [4]),
    .ZN(wr_ptr_en));
 ...
 MUX2_X1 \controller/_55_  (.A(\controller/_10_ ),
    ...
    .S(wr_ptr_en),
    .Z(\controller/_15_ ));
 NAND2_X1 \controller/_56_  (.A1(\controller/count [3]),
    .A2(\controller/_15_ ),
    .ZN(\controller/_16_ ));
 XOR2_X1 \controller/_57_  (.A(\controller/count [3]),
    .B(\controller/_07_ ),
    .Z(\controller/_17_ ));
 NAND2_X1 \controller/_58_  (.A1(\controller/count [0]),
    .A2(\controller/count [1]),
    .ZN(\controller/_18_ ));
 NAND3_X1 \controller/_59_  (.A1(\controller/count [0]),
    .A2(\controller/count [1]),
    .A3(\controller/count [2]),
    .ZN(\controller/_19_ ));
 NAND4_X1 \controller/_60_  (.A1(\controller/count [0]),
    .A2(\controller/count [1]),
    .A3(\controller/count [2]),
    .A4(\controller/count [3]),
    .ZN(\controller/_20_ ));
 XNOR2_X1 \controller/_61_  (.A(\controller/count [3]),
    .B(\controller/_19_ ),
    .ZN(\controller/_21_ ));
 ...
 AOI21_X1 \controller/_63_  (.A(rst),
    ...
    .B2(\controller/_22_ ),
    .ZN(\controller/_00_ ));
 NAND2_X1 \controller/_64_  (.A1(\controller/count [2]),
    .A2(\controller/_15_ ),
    .ZN(\controller/_23_ ));
 XOR2_X1 \controller/_65_  (.A(\controller/count [2]),
    .B(\controller/_06_ ),
    .Z(\controller/_24_ ));
 XNOR2_X1 \controller/_66_  (.A(\controller/count [2]),
    .B(\controller/_18_ ),
    .ZN(\controller/_25_ ));
 ...
 AOI21_X1 \controller/_68_  (.A(rst),
    ...
    .B2(\controller/_26_ ),
    .ZN(\controller/_01_ ));
 NAND2_X1 \controller/_69_  (.A1(\controller/count [1]),
    .A2(\controller/_15_ ),
    .ZN(\controller/_27_ ));
 XOR2_X1 \controller/_70_  (.A(\controller/count [0]),
    .B(\controller/count [1]),
    .Z(\controller/_28_ ));
 ...
 AOI21_X1 \controller/_73_  (.A(rst),
    ...
    .B2(\controller/_30_ ),
    .ZN(\controller/_02_ ));
 XOR2_X1 \controller/_74_  (.A(\controller/count [0]),
    .B(\controller/_15_ ),
    .Z(\controller/_31_ ));
 ...
 INV_X1 \memory/_0586_  (.A(\memory/mem[15] [6]),
    .ZN(\memory/_0138_ ));
 INV_X1 \memory/_0587_  (.A(rd_ptr[0]),
    .ZN(\memory/_0139_ ));
 ...
 NOR2_X2 \memory/_0732_  (.A1(rd_ptr[0]),
    .A2(rd_ptr[1]),
    .ZN(\memory/_0284_ ));
 OR2_X1 \memory/_0733_  (.A1(\memory/_0139_ ),
    .A2(rd_ptr[1]),
    .ZN(\memory/_0285_ ));
 AND2_X1 \memory/_0734_  (.A1(rd_ptr[0]),
    .A2(rd_ptr[1]),
    .ZN(\memory/_0286_ ));
 ...
 AOI21_X1 \memory/_0839_  (.A(\memory/_0384_ ),
    ...
    .B2(\memory/_0382_ ),
    .ZN(\memory/_0006_ ));
 NOR2_X1 \memory/_0840_  (.A1(rst),
    .A2(\memory/_0253_ ),
    .ZN(\memory/_0385_ ));
 AOI211_X1 \memory/_0841_  (.A(rst),
    .B(\memory/_0253_ ),
    .C1(\memory/_0279_ ),
    .C2(\memory/_0252_ ),
    .ZN(\memory/_0386_ ));
 AOI211_X1 \memory/_0842_  (.A(rst),
    .B(\memory/_0253_ ),
    .C1(\memory/_0254_ ),
    .C2(\memory/_0255_ ),
    .ZN(\memory/_0387_ ));
 OR4_X1 \memory/_0843_  (.A1(rst),
    .A2(\memory/_0253_ ),
    .A3(\memory/_0386_ ),
    .A4(\memory/_0387_ ),
    .ZN(\memory/_0388_ ));
 NAND2_X1 \memory/_0844_  (.A1(\memory/_0251_ ),
    .A2(\memory/_0388_ ),
    .ZN(\memory/_0389_ ));
 ...
 NAND4_X1 \memory/_0852_  (.A1(\memory/_0251_ ),
    ...
    .A4(wr_ptr[0]),
    .ZN(\memory/_0390_ ));
 OR2_X1 \memory/_0853_  (.A1(\memory/_0386_ ),
    .A2(\memory/_0390_ ),
    .ZN(\memory/_0391_ ));
 NAND2_X1 \memory/_0854_  (.A1(\memory/_0251_ ),
    .A2(\memory/_0391_ ),
    .ZN(\memory/_0392_ ));
 NAND2_X1 \memory/_0855_  (.A1(data_in[6]),
    .A2(\memory/_0385_ ),
    .ZN(\memory/_0393_ ));
 OAI22_X1 \memory/_0856_  (.A1(\memory/_0237_ ),
    ...
    .B2(\memory/_0391_ ),
    .ZN(\memory/_0014_ ));
 NAND2_X1 \memory/_0857_  (.A1(data_in[5]),
    .A2(\memory/_0385_ ),
    .ZN(\memory/_0394_ ));
 OAI22_X1 \memory/_0858_  (.A1(\memory/_0239_ ),
    ...
    .B2(\memory/_0391_ ),
    .ZN(\memory/_0015_ ));
 NAND2_X1 \memory/_0859_  (.A1(data_in[4]),
    .A2(\memory/_0385_ ),
    .ZN(\memory/_0395_ ));
 OAI22_X1 \memory/_0860_  (.A1(\memory/_0241_ ),
    ...
    .B2(\memory/_0391_ ),
    .ZN(\memory/_0016_ ));
 NAND2_X1 \memory/_0861_  (.A1(data_in[3]),
    .A2(\memory/_0385_ ),
    .ZN(\memory/_0396_ ));
 OAI22_X1 \memory/_0862_  (.A1(\memory/_0243_ ),
    ...
    .B2(\memory/_0391_ ),
    .ZN(\memory/_0017_ ));
 NAND2_X1 \memory/_0863_  (.A1(data_in[2]),
    .A2(\memory/_0385_ ),
    .ZN(\memory/_0397_ ));
 OAI22_X1 \memory/_0864_  (.A1(\memory/_0245_ ),
    ...
    .B2(\memory/_0391_ ),
    .ZN(\memory/_0018_ ));
 NAND2_X1 \memory/_0865_  (.A1(data_in[1]),
    .A2(\memory/_0385_ ),
    .ZN(\memory/_0398_ ));
 OAI22_X1 \memory/_0866_  (.A1(\memory/_0247_ ),
    ...
    .B2(\memory/_0391_ ),
    .ZN(\memory/_0019_ ));
 NAND2_X1 \memory/_0867_  (.A1(data_in[0]),
    .A2(\memory/_0385_ ),
    .ZN(\memory/_0399_ ));
 ...
 NAND4_X1 \memory/_0869_  (.A1(\memory/_0251_ ),
    ...
    .A4(\memory/_0255_ ),
    .ZN(\memory/_0400_ ));
 OR2_X1 \memory/_0870_  (.A1(\memory/_0386_ ),
    .A2(\memory/_0400_ ),
    .ZN(\memory/_0401_ ));
 ...
 NAND4_X1 \memory/_0879_  (.A1(\memory/_0251_ ),
    ...
    .A4(wr_ptr[0]),
    .ZN(\memory/_0403_ ));
 OR2_X1 \memory/_0880_  (.A1(\memory/_0386_ ),
    .A2(\memory/_0403_ ),
    .ZN(\memory/_0404_ ));
 ...
 NAND4_X1 \memory/_0889_  (.A1(\memory/_0251_ ),
    ...
    .A4(\memory/_0279_ ),
    .ZN(\memory/_0406_ ));
 OR2_X1 \memory/_0890_  (.A1(\memory/_0387_ ),
    .A2(\memory/_0406_ ),
    .ZN(\memory/_0407_ ));
 NAND2_X1 \memory/_0891_  (.A1(\memory/net5 ),
    .A2(\memory/_0407_ ),
    .ZN(\memory/_0408_ ));
 ...
 OAI22_X1 \memory/_0898_  (.A1(\memory/_0399_ ),
    ...
    .B2(\memory/_0220_ ),
    .ZN(\memory/_0041_ ));
 OR2_X1 \memory/_0899_  (.A1(\memory/_0390_ ),
    .A2(\memory/_0406_ ),
    .ZN(\memory/_0409_ ));
 ...
 OAI22_X1 \memory/_0907_  (.A1(\memory/_0399_ ),
    ...
    .B2(\memory/_0221_ ),
    .ZN(\memory/_0048_ ));
 OR2_X1 \memory/_0908_  (.A1(\memory/_0400_ ),
    .A2(\memory/_0406_ ),
    .ZN(\memory/_0411_ ));
 ...
 OAI22_X1 \memory/_0916_  (.A1(\memory/_0399_ ),
    ...
    .B2(\memory/_0206_ ),
    .ZN(\memory/_0055_ ));
 OR2_X1 \memory/_0917_  (.A1(\memory/_0403_ ),
    .A2(\memory/_0406_ ),
    .ZN(\memory/_0413_ ));
 ...
 NAND4_X1 \memory/_0926_  (.A1(\memory/_0251_ ),
    ...
    .A4(wr_ptr[3]),
    .ZN(\memory/_0415_ ));
 OR2_X1 \memory/_0927_  (.A1(\memory/_0387_ ),
    .A2(\memory/_0415_ ),
    .ZN(\memory/_0416_ ));
 NAND2_X1 \memory/_0928_  (.A1(\memory/net5 ),
    .A2(\memory/_0416_ ),
    .ZN(\memory/_0417_ ));
 ...
 NAND4_X1 \memory/_0963_  (.A1(\memory/_0251_ ),
    ...
    .A4(wr_ptr[3]),
    .ZN(\memory/_0424_ ));
 OR2_X1 \memory/_0964_  (.A1(\memory/_0387_ ),
    .A2(\memory/_0424_ ),
    .ZN(\memory/_0425_ ));
 NAND2_X1 \memory/_0965_  (.A1(\memory/_0251_ ),
    .A2(\memory/_0425_ ),
    .ZN(\memory/_0426_ ));
 ...
 OAI22_X1 \memory/_0972_  (.A1(\memory/_0399_ ),
    ...
    .B2(\memory/_0164_ ),
    .ZN(\memory/_0097_ ));
 OR2_X1 \memory/_0973_  (.A1(\memory/_0390_ ),
    .A2(\memory/_0424_ ),
    .ZN(\memory/_0427_ ));
 ...
 OAI22_X1 \memory/_0981_  (.A1(\memory/_0399_ ),
    ...
    .B2(\memory/_0165_ ),
    .ZN(\memory/_0104_ ));
 OR2_X1 \memory/_0982_  (.A1(\memory/_0400_ ),
    .A2(\memory/_0424_ ),
    .ZN(\memory/_0429_ ));
 ...
 OAI22_X1 \memory/_0990_  (.A1(\memory/_0399_ ),
    ...
    .B2(\memory/_0150_ ),
    .ZN(\memory/_0111_ ));
 OR2_X1 \memory/_0991_  (.A1(\memory/_0403_ ),
    .A2(\memory/_0424_ ),
    .ZN(\memory/_0431_ ));
 ...
 AOI21_X1 \memory/_1014_  (.A(\memory/_0446_ ),
    ...
    .B2(\memory/_0444_ ),
    .ZN(\memory/_0119_ ));
 NAND2_X1 \memory/_1015_  (.A1(data_in[7]),
    .A2(\memory/_0385_ ),
    .ZN(\memory/_0447_ ));
 ...
 AOI21_X1 \rd_pointer/_18_  (.A(\rd_pointer/_06_ ),
    ...
    .B2(rd_ptr[2]),
    .ZN(\rd_pointer/_00_ ));
 AOI21_X1 \rd_pointer/_19_  (.A(rd_ptr[1]),
    .B1(rd_ptr[0]),
    .B2(rd_ptr_en),
    .ZN(\rd_pointer/_07_ ));
 ...
 DFF_X1 \rd_pointer/_26_  (.D(\rd_pointer/_02_ ),
    ...
    .Q(rd_ptr[0]),
    .QN(\rd_pointer/_12_ ));
 DFF_X1 \rd_pointer/_27_  (.D(\rd_pointer/_01_ ),
    .CK(clk),
    .Q(rd_ptr[1]),
    .QN(\rd_pointer/_13_ ));
